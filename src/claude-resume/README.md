...
When given a search term instead of a session ID, the script searches for sessions containing the text (case-insensitive) and lets you pick one interactively: `[r]esume this session / [k]eep looking / [a]bort?`
